...
class BankAccount {
    ...
    public BankAccount(String userId, String userPin) {
        ...
        this.balance = 0.0;
        this.transactionHistory = new Transaction[100]; // Assuming a maximum of 100 transactions
...
class ATM {
    ...
    private BankAccount verifyUser(String userId, String pin) {
        ...
        // For simplicity, we will hardcode a single user with id "123" and pin "456".
